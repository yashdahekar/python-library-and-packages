...
-- 'F:\Ineuron work\python library and packages\station.csv'
-- 'C:\ProgramData\MySQL\MySQL Server 8.0\Uploads\station.csv'
...
(566, 'Marine On Saint Croix', 'MN', 126, 142),
...
-- 8
select distinct city, id from station where ID % 2 = 0 order by id asc;
-- 9
select  count(city) as 'no_of_cities', count(distinct city) 'distinct_no_of_cities' ,(count(city) - count(distinct city)) 
as 'difference' from station;
-- 10
